      ...
      <Fragment className="container">
         <form onSubmit={props.handleSubmit} align="left" className="form1">
            ...
            <Grid>
               ...
               {props.recentDevelopments.map((item, index) => (
                  <Grid key={`recent${index}`}>
                     <div
                        ...
                        <div>
                           <FormControl>
                              <InputLabel htmlFor={`recentTitle${index}`}>
                                 Title
                              </InputLabel>
                              <Input
                                 id={`recentTitle${index}`}
                                 aria-describedby="bloombergcode-helper"
                        ...
                        <div>
                           <FormControl>
                              <InputLabel htmlFor={`recentLink${index}`}>
                                 Resource link
                              </InputLabel>
                              <Input
                                 id={`recentLink${index}`}
                        ...
                        <Button onClick={() => removeRecentDevelopment(index)}>
                           Delete
                        </Button>
                     </div>
                  </Grid>
               ...
               <br />
               <Box textAlign="left">
                  <Button onClick={addRecentDevelopments}>
               ...
               {props.esgInitiatives.map((item, index) => (
                  <Grid key={`esg${index}`}>
                     <div
                        ...
                        <div>
                           <FormControl>
                              <InputLabel htmlFor={`esgTitle${index}`}>
                                 Title
                              </InputLabel>
                              <Input
                                 key={`esgTitle${index}`}
                                 onChange={(e) =>
                                    handleEsgTitleChange(e, index)
                                 }
                                 name={`esgTitle${index}`}
                                 id={`esgTitle${index}`}
                                 aria-describedby="bloombergcode-helper"
                        ...
                        <div>
                           <FormControl>
                              <InputLabel htmlFor={`esgLink${index}`}>
                                 Resource link
                              </InputLabel>
                              <Input
                                 key={`esgLink${index}`}
                                 onChange={(e) => handleEsgLinkChange(e, index)}
                                 name={`esgLink${index}`}
                                 id={`esgLink${index}`}
                                 aria-describedby="bloombergcode-helper"
                                 defaultValue={item.link}
                        ...
                        <Button onClick={() => removeEsgInitiatives(index)}>
                           Delete
                        </Button>
                     </div>
                  </Grid>
               ...
               <br />
               <Box textAlign="left">
                  <Button onClick={addEsgInitiatives}>
                     + New ESG Initiatives
                  </Button>
               </Box>
               <br />
               ...
               {props.isCreateNew && (
                  <Box textAlign="right">
                     <Button variant="contained" onClick={props.handleCreate}>
                        Create
                     </Button>
                  </Box>
               )}
