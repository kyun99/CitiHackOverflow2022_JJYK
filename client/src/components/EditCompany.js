...
const EditCompany = (props) => {
   const [recentDevelopments, setRecentDevelopments] = useState([
      {
         title: "Yangzijiang Shipbuilding Holdings Ltd: A good set of 1H22 results",
         link: "https://www.dbs.com.sg/private-banking/aics/templatedata/article/recentdevelopment/data/en/DBSV/082022/YZJSGD_SP_08082022.xml",
      },
      {
         title: "Yangzijiang Shipbuilding: Trading at unwarranted deep discount to peers",
         link: "https://www.dbs.com.sg/private-banking/aics/templatedata/article/recentdevelopment/data/en/DBSV/082022/YZJSGD_SP_08042022.xml",
      },
   ]);

   const [esgInitiatives, setEsgInitiatives] = useState([
      {
         title: "Yangzijiang Shipbuilding Holdings reduces carbon emissions in 1H22",
         link: "https://www.dbs.com.sg/private-banking/aics/templatedata/article/recentdevelopment/data/en/DBSV/082022/YZJSGD_SP_08082022.xml",
      },
      {
         title: "Yangzijiang Shipbuilding Increase resiliance of supply chain",
         link: "https://www.dbs.com.sg/private-banking/aics/templatedata/article/recentdevelopment/data/en/DBSV/082022/YZJSGD_SP_08042022.xml",
      },
   ]);
   ...
   const handleUpdate = (e) => {
      ...
      console.log(data);
      axios
         .put(`http://127.0.0.1:8000/moneyplant/company/${bloombergCode}`, data)
         .then((resp) => {
            console.log(resp.status);
   ...
   const handleDelete = () => {
      axios
         .delete(`http://127.0.0.1:8000/moneyplant/company/${bloombergCode}`)
         .then((resp) => {
            console.log(resp.status);
            setRedirect((prev) => true);
         })
